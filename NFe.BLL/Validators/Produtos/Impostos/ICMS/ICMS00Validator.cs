...
namespace NFe.BLL.Validators.Produtos.Impostos.ICMS
{
    public class ICMS00Validator : AbstractValidator<Configuracao.Entidades.Produtos.Impostos.ICMS.ICMS>
    {
        public ICMS00Validator()
        {
            ...
            RuleFor(icms => icms.Aliquota).GreaterThan(0).WithMessage("Alíquota do ICMS 00 é inválida!");
            RuleFor(icms => icms.ValorTotal).GreaterThan(0).WithMessage("Valor Total do ICMS 00 é inválido!");
        }
    }
}
