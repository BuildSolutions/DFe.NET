    ...
    public class GnreConsultaResultadoLote2 : INfeServico
    {
        ...
        public XmlNode Execute(XmlNode gnreDadosMsg)
        {
            ...
            return RequestBuilderAndSender.Execute(soapEnvelope, configuracao,
                actionUrn: "http://www.gnre.pe.gov.br/webservice/GnreResultadoLote/consultar",
        ...
        {
            [XmlElement(Namespace = "http://www.gnre.pe.gov.br/gnreWS/services/GnreResultadoLote")]
