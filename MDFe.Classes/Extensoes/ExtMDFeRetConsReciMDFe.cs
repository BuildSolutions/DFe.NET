...
namespace MDFe.Classes.Extencoes
{
    public static class ExtMDFeRetConsReciMDFe
    {
        public static void SalvarXmlEmDisco(this MDFeRetConsReciMDFe consReciMdFe)
        {
            ...
            var data = consReciMdFe.ProtMdFe.InfProt.DhRecbto;
            ...
            var arquivoSalvar = System.IO.Path.Combine(caminhoXml,
                "Recibos",
                strFolderYear,
                strFolderMonth) + @"\" + consReciMdFe.NRec + "-pro-rec.xml";

            FuncoesXml.ClasseParaArquivoXml(consReciMdFe, arquivoSalvar, true);
        }
    }
}