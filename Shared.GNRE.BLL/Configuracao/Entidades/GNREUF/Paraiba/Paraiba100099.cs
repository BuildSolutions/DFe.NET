...
{
    public class Paraiba100099 : GNRE
    {
        public Paraiba100099(Emitente emitente,
            ...
            string convenio = null)
        {
            ...
            camposExtras = new List<CampoExtra>() { new CampoExtra((int)ETipoCampoExtraPB.ChaveAcessoNFe, ETipoCampoExtraPB.ChaveAcessoNFe.ToString(), chaveAcessoNFe) };
